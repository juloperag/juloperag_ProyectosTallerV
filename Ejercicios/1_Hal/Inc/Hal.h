...
#define GPIOA			((GPIOx_RegDef_t *)	GIOA_BASE_ADDR)
#define GPIOB			((GPIOx_RegDef_t *)	GIOB_BASE_ADDR)
#define GPIOC			((GPIOx_RegDef_t *)	GIOC_BASE_ADDR)
#define GPIOD			((GPIOx_RegDef_t *)	GIOD_BASE_ADDR)
#define GPIOE			((GPIOx_RegDef_t *)	GIOE_BASE_ADDR)
#define GPIOH			((GPIOx_RegDef_t *)	GIOH_BASE_ADDR)
